...
function ClientHeader(props) {
    ...
    return (
        <div className="client-common-header">
            ...
            {isShowOptions && <HeaderOptions showProfile={showProfile} onClose={() => { setisShowOptions(value => !value) }} />}
            {isShowProfile && <ClientProfile onClose={() => { setisShowProfile(value => !value) }} />}
        </div>
    )
}
